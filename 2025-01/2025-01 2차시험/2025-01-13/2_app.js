...
const indexRoutes = require( './2_index/index');
const todoRoutes = require( './2_todo/index');
...
// view 엔진 설정
app.set('views', path.join(__dirname, './2_views')); // 2_views 폴덜르 바라보도록 설정
...
//   -> 여기서 js는 클라이언트단의 js
app.use(express.static(path.join(__dirname, '2_static'))); // static 파일 경로 설정
